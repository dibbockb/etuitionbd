    ...
    return (
        <div className="w-full space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="backdrop-blur-2xl p-5 rounded-2xl bg-gray-400/10 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                    <div className="flex items-center justify-between mb-4">
                        <div className="bg-blue-500/20 p-3 rounded-lg">
                            <FiBook className="w-6 h-6 text-blue-400" />
                        </div>
                    </div>
                    <h3 className="text-gray-400 text-sm font-medium mb-1">Total Tuitions</h3>
                ...
                <div className="backdrop-blur-2xl p-5 rounded-2xl bg-gray-400/10 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                    ...
                    <h3 className="text-gray-400 text-sm font-medium mb-1">Platform Revenue</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-900 border border-white/10 rounded-xl p-6">
                    <h3 className="text-white text-lg font-semibold mb-4">Tuition Status Overview</h3>
            ...
            {/* Summary Stats Row */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-900/50 border border-white/5 rounded-xl p-6">
                <div className="text-center">
                    <p className="text-gray-400 text-sm mb-2">Tuition Accept Rate</p>
                    <p className="text-2xl font-bold text-[#06f8e0]">{totalTuitions > 0 ? ((approvedTuitions / totalTuitions) * 100).toFixed(1) : 0}%</p>
                </div>
                <div className="text-center border-l border-r border-white/10">
                    <p className="text-gray-400 text-sm mb-2">Average Tutor Salary</p>
                ...
                <div className="text-center">
                    <p className="text-gray-400 text-sm mb-2">Total Successful Transation</p>
